...
public:
	...
	void DrawTextD2D(Vector2 pos, wstring txt, int txtSize, ColorF color = ColorF(0, 0, 0, 1.0f), TextPivot point = TextPivot::LEFT_TOP, wstring font = L"¸¼Àº°íµñ", bool cameraAffect = false);
	void DrawTextD2D(Vector2 pos, const char* txt, int txtSize, ColorF color = ColorF(0, 0, 0, 1.0f), TextPivot point = TextPivot::LEFT_TOP, wstring font = L"¸¼Àº°íµñ", bool cameraAffect = false);


	void Text(Vector2 pos, wstring txt, int txtSize, float maxWidth, float maxHeight, ColorF color = ColorF(0, 0, 0, 1.0f), TextPivot point = TextPivot::LEFT_TOP, wstring font = L"¸¼Àº°íµñ", bool cameraEffect = false);
	void Text(Vector2 pos, const char* txt, int txtSize, float maxWidth, float maxHeight, ColorF color = ColorF(0, 0, 0, 1.0f), TextPivot point = TextPivot::LEFT_TOP, wstring font = L"¸¼Àº°íµñ", bool cameraEffect = false);
