...
public:
	...
	void Text(Vector2 pos, wstring txt, int txtSize, float maxWidth, float maxHeight, ColorF::Enum color = ColorF::Black, float alpha = 1.0f, TextPivot point = TextPivot::LEFT_TOP, wstring font = L"¸¼Àº°íµñ", bool cameraAffect = false);
	void Text(Vector2 pos, const char* txt, int txtSize, float maxWidth, float maxHeight, ColorF::Enum color = ColorF::Black, float alpha = 1.0f, TextPivot point = TextPivot::LEFT_TOP, wstring font = L"¸¼Àº°íµñ", bool cameraAffect = false);
