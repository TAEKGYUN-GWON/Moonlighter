...
void GraphicsManager::Text(Vector2 pos, wstring txt, int txtSize, float maxWidth, float maxHeight, ColorF::Enum color, float alpha, TextPivot point, wstring font, bool cameraAffect)
{
...
void GraphicsManager::Text(Vector2 pos, const char* txt, int txtSize, float maxWidth, float maxHeight, ColorF::Enum color, float alpha, TextPivot point, wstring font, bool cameraAffect)
{
	string buffer = txt;
	wstring str;
	str.assign(buffer.begin(), buffer.end());
